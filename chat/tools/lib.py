...
_tool_defs = {
    ...
    'view parasite data': {
        ...
        'tool text': 'Plz',
        'data function': lambda conn: conn._user_list.get_all(),
        'no data': 'There is nobody to view. Where did you go?',
    ...
    'view room data': {
        ...
        'tool type': 'data',
        'data type': 'room',
        'display name': 'View room data',
        'tool description': 'View whatever a room\'s current data looks like.',
        'tool text': 'Plz',
        'data function': lambda conn: conn._room_list.get_room_list(),
        'no data': 'There are no rooms to view. Sad.',
        'tool confirm': lambda data: json.dumps(data, indent=4),
    },
}
